...
from databox.api_response import ApiResponse, T as ApiResponseT
import databox.models
from databox import rest
from databox.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(databox.models, klass)
